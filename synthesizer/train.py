...
def train(log_dir, args, hparams):
    ...
    # Embeddings metadata, meta_folder is a log directory
    ...
    with tf.Session(config=config) as sess:
        try:
            ...
            if args.restore:
                ...
                log("Starting new training!, with downloaded synthesizer model.", slack=True)
########################## loading the downloaded synthesizer model ###########
                syn_path = 'synthesizer/saved_models/logs-pretrained/taco_pretrained'
                saver.restore(sess=sess, save_path=syn_path)

                saver.save(sess, checkpoint_fpath, global_step=global_step)

            # initializing feeder
            feeder.start_threads(sess)  # training thread is starting here.
            ...
            while not coord.should_stop() and step < args.tacotron_train_steps:
                ...
                if step % args.eval_interval == 0:   # evaluation interval you are passing at the time of executing this
                    ...
                    if hparams.predict_linear:   # hparams.predict_linear is False
