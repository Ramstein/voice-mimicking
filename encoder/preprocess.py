...
def _init_preprocess_dataset(dataset_name, datasets_root, out_dir) -> (Path, DatasetLog):
    ...
    # 'C:\Users\Ramstein\Desktop\voice-mimicking' + 'LibriSpeech/train-clean-100'
...
def preprocess_librispeech(datasets_root: Path, out_dir: Path, skip_existing=False):
    for dataset_name in librispeech_datasets["train"]["clean"]:  # "LibriSpeech/train-other-500" not available
        ...
        if not dataset_root:#dataset_root= 'C:\Users\Ramstein\Desktop\voice-mimicking' + 'LibriSpeech/train-clean-100'
            return 
        
        # Preprocess all speakers
        speaker_dirs = list(dataset_root.glob("*"))  # speakers-19, speakers-26, speakers-27, speakers-32, speakers-39, speakers-40 .....
